...
class Bot:
    ...
    Если шаг не пройден, то задаем уточняющий вопрос пока шаг не будет пройден.
    """
    ...
    def send_step(self, step, user_id, text, context):
        """
        Служит для перехода на следующий шаг сценария, если он есть
    ...
    def continue_scenario(self, text, state, user_id):
        """
        Продолжает сценарий на том месте где остановился (использует состояние из БД)
